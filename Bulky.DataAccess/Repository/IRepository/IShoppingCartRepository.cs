...
{ //We need our category to implement the repository
    public interface IShoppingCartRepository: IRepository<ShoppingCart> // We know the class on which we want the implementatation for this class. when we need the implementation for Icategoryrepository, we to get the base functionality from repository.
    ...
    {
        void UpdateShoppingCart(ShoppingCart obj);
